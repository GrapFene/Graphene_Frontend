        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-2 bg-pink-300 dark:bg-cyan-600 border-4 border-black dark:border-gray-700 px-4 py-2 font-black hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(50,50,50,1)] text-black dark:text-white"
            >
            ...
            <button onClick={() => window.location.href = '/profile'} className="bg-lime-400 dark:bg-emerald-600 border-4 border-black dark:border-gray-700 hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(50,50,50,1)] text-black dark:text-white overflow-hidden relative w-12 h-12 flex items-center justify-center">
              {avatarUrl ? (
